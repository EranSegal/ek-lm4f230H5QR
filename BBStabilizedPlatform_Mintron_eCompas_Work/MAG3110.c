...
void MAG3110getXYZ(float *pfMagnetoX,float *pfMagnetoY, float *pfMagnetoZ)
{
  int i;
  magready = false;
  ...
  *pfMagnetoX = (float)MAG3110values[0];
  *pfMagnetoX *= CONVERT_TO_TESLA;  

  *pfMagnetoY = (float)MAG3110values[1];
  *pfMagnetoY *= CONVERT_TO_TESLA;  

  *pfMagnetoZ = (float)MAG3110values[2];
