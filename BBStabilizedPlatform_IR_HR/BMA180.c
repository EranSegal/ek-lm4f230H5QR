...
void BMA180Init()
{
  ...
  bmaregs[OLSB1] = RANGE15<< RANGESHIFT;
...
void BMA180GetXYZ()
{
  ...
  I2C_Send1(BMA180_SLAVE_ADDRESS, ACCXLSB); 
  BMA180values[0] = I2C_Recv2(BMA180_SLAVE_ADDRESS);    // read ITG3200_WHO_AM_I

  I2C_Send1(BMA180_SLAVE_ADDRESS, ACCYLSB); 
  BMA180values[1] = I2C_Recv2(BMA180_SLAVE_ADDRESS);    // read ITG3200_WHO_AM_I

  I2C_Send1(BMA180_SLAVE_ADDRESS, ACCZLSB); 
  BMA180values[2] = I2C_Recv2(BMA180_SLAVE_ADDRESS);    // read ITG3200_WHO_AM_I
  #endif
